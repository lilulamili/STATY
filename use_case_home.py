...
def app():
    ...
    st.write("STATY is still under development, and some features may not yet work properly! STATY is therefore provided 'as is' without any warranties of any kind.")
