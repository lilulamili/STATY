...
def app():
    ...
    with data_exploration_container:
        dev_expander_raw = st.beta_expander("Explore raw data info and stats")
        ...
        with dev_expander_dm_sb:
            ...
            with a3:
                ...
                sb_DM_dTrans_div = st.number_input("Number of variable divisions ", value = 0, key = session_state.id)
