...
def app():
    ...
    with general_questions_container:
        ...
        with st.beta_expander("Which libraries were used for figures?"):
        ...
        with st.beta_expander("What are robust covariance matrices and when are they needed?"):
    ...
    with uniBivariate_questions_container:
        ...
        with st.beta_expander("Which libraries are used within uni- and bivariate data analyses?"):
    ...
    with multivariate_questions_container:
        ...
        with st.beta_expander("Which libraries are used for the multivariate data regression models?"):
        ...
        with st.beta_expander("Which libraries are used for multivariate data decomposition?"):
    ...
    with timeseries_questions_container:
        ...
        with st.beta_expander("Which libraries are used for time series models?"):
    ...
    with webAndText_questions_container:
        ...
        with st.beta_expander("Which libraries are used for web scraping and text data analyses?"):
    ...
    with geospatial_questions_container:
        ...
        with st.beta_expander("Which libraries are used for geospatial data processing?"):
